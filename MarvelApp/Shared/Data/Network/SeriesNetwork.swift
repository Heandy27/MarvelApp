...
final class SeriesNetworkMock: SeriesNetworkProtocol {
    func getSeries(id: Int) async -> [ResultSeries] {
        ...
        let model1 = ResultSeries(id: id, title: "Avengers: The Initiative (2007 - 2010)", description: nil, thumbnail: ThumbnailSeries(path: "http://i.annihil.us/u/prod/marvel/i/mg/5/a0/514a2ed3302f5", fileExtension: "jpg"))
        
        let model2 = ResultSeries(id: id, title: "Deadpool (1997 - 2002)", description: "Wade Wilson: Heartless Merc With a Mouth or...hero? Laugh, cry and applaud at full volume for the mind-bending adventures of Deadpool, exploring the psyche and crazed adventures of Marvel's most unstable personality!", thumbnail: ThumbnailSeries(path: "http://i.annihil.us/u/prod/marvel/i/mg/7/03/5130f646465e3", fileExtension: "jpg"))
